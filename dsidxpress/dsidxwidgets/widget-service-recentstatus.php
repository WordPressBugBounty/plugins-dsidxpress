...
class dsIDXWidgets_RecentStatus extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct("dsidx-recentstatus", "Recent Properties", array(
    ...
    function widget($args, $instance) {
        ...
        $rowCount = esc_html($instance["rowCount"]);
        $community = esc_html($instance["community"]);
        $state = esc_html($instance["state"]);
        $city = esc_html($instance["city"]);
        $zip = esc_html($instance["zip"]);
        $linkTitle = esc_html($instance["linkTitle"]);
...
HTML;
    ...
    function update($new_instance, $old_instance) {
        ...
        $new_instance["recentstatusOptions"]["title"] = sanitize_text_field($new_instance["title"]);
        $new_instance["recentstatusOptions"]["rowCount"] = sanitize_text_field($new_instance["rowCount"]);
        $new_instance["recentstatusOptions"]["community"] = sanitize_text_field($new_instance["community"]);
        $new_instance["recentstatusOptions"]["state"] = sanitize_text_field($new_instance["state"]);
        $new_instance["recentstatusOptions"]["city"] = sanitize_text_field($new_instance["city"]);
        $new_instance["recentstatusOptions"]["zip"] = sanitize_text_field($new_instance["zip"]);
        $new_instance["recentstatusOptions"]["linkTitle"] = sanitize_text_field($new_instance["linkTitle"]);
        $new_instance["recentstatusOptions"]["statusType"] = sanitize_text_field($new_instance["statusType"]);

        if(isset($new_instance["recentstatusOptions"]["eDomain"]))
            $new_instance["recentstatusOptions"]["eDomain"] = sanitize_text_field($new_instance["eDomain"]);
            
        $new_instance["recentstatusOptions"]["width"] = sanitize_text_field($new_instance["width"]);
    ...
    function form($instance) {
        ...
        $status = esc_attr($instance["statusType"]); 
