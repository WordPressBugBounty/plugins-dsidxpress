...
class dsWidgetAgent_ApiRequest {
    public static $ApiEndPoint = "https://api-b.idx.diversesolutions.com/api/";
	...
	static function FetchData($action, $params = array(), $echoAssetsIfNotEnqueued = true, $cacheSecondsOverride = null, $options = null, $headers = array()) {
		...
		if(isset($_COOKIE['dsidx-visitor-details-views']))
			$params["requester.VisitorDetailViews"] = sanitize_text_field($_COOKIE['dsidx-visitor-details-views']);
		if(isset($_COOKIE['dsidx-visitor-results-views']))
			$params["requester.VisitorResultsViews"] = sanitize_text_field($_COOKIE['dsidx-visitor-results-views']);
